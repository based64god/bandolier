...
export function PullToRefresh() {
  ...
  return (
    ...
    >
      <div className="mt-[max(0.5rem,env(safe-area-inset-top))] flex h-9 w-9 items-center justify-center rounded-full border border-white/10 bg-[#15162c]/95 text-white shadow-lg backdrop-blur">
        <svg
          viewBox="0 0 24 24"
          fill="none"
          stroke="currentColor"
